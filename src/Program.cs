...
namespace PortScanner
{
    class Program
    {
...

        {
            ...
            {
                if (mainArgs[2] != "TCP" || mainArgs[2] == "UDP")
                {
                    Console.WriteLine("");
                    Console.WriteLine("");
                    Console.WriteLine("******************************************");
                    Console.WriteLine("That protocol is not supported. Try again.");
                    Console.WriteLine("******************************************");
                    Console.WriteLine("");
                    Console.WriteLine("");
                }
            ...
            if (mainArgs.Length < 1 || mainArgs.Length < 2 || mainArgs.Length > 3)
            {
            ...
            String servr = mainArgs[0];  // Server name or IP address

            //Check whether user supplied one port or a range of ports (lowPort:highPort)
            string[] mainPorts = mainArgs[1].Split(':');





            if ((mainArgs.Length == 3 && mainArgs[2] == "TCP") || mainArgs.Length == 2)
            {
                ...
                {
                    int lowPort = Int32.Parse(mainPorts[0]);
                    ...
                    //    Console.WriteLine("");
                    //    Console.WriteLine("******************************************");
                    //    Console.WriteLine("Port zero is an unusable port.  Try again.");
                    //    Console.WriteLine("******************************************");
                    //    Console.WriteLine("");
                    //    Console.WriteLine("");
                    //}
                ...
                else if (mainPorts.Length == 2)
                {
                    int lowPort = Int32.Parse(mainPorts[0]);
                    int highPort = Int32.Parse(mainPorts[1]);
            ...
            //if (mainPorts.Length > 2 || mainArgs.Length > 3)
            //{
            //    Console.WriteLine("");
            //    Console.WriteLine("");
            //    Console.WriteLine("******************************************");
